...
public class ProDivaky {
    ...
    public Node createRight(){
        ...
        casCol22.setCellValueFactory(new PropertyValueFactory<>("vylouceni"));
        ...
        casCol52.setCellValueFactory(new PropertyValueFactory<>("vylouceni"));
    ...
    public Node createLeft(){
        ...
        casCol21.setCellValueFactory(new PropertyValueFactory<>("vylouceni"));
        ...
        casCol51.setCellValueFactory(new PropertyValueFactory<>("vylouceni"));
