public class Barakudy extends AAnimal implements Ryby{
    String vajicka = "1000 barakudich vajec";
    String jidlo = "Maso";
    String pohyb = "Plave do hloubky";

    public Barakudy(String name, float x, float y, int energie) {
